...
<title>Stand alone Deployment - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/deploy/beego.md">Stand alone Deployment</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/deploy/beego.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<h1>Stand alone Deployment</h1>

<p>This will run application in the backend as a daemon.</p>

<h2>linux</h2>

<p>In Linux we can use <code>nohup</code> command to run the application in the backend:</p>

<pre><code>nohup ./beepkg &amp;
</code></pre>

<p>Your application is running in the keep process of Linux.</p>

<h2>Windows</h2>

<p>In Windows, set to auto run in the backend on start. Two ways to do that:</p>

<ol>
<li>Create a bat file and put it into &ldquo;Run&rdquo;<br /></li>
<li>Create a service<br /></li>
</ol>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'deploy\/beego.md?lang=en-US';
            </script>
