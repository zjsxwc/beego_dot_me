...
<title>Deployment with Supervisord - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/deploy/supervisor.md">Deployment with Supervisord</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/deploy/supervisor.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>Supervisord is a very useful process manager implemented in Python.  Supervisord can change your non-daemon application into a daemon application. The application needs to be a non-daemon app.<br />
So if you want to use Supervisord to manage nginx, you need to set daemon off to run nginx in non-daemon mode.</p>

<h2>Install Supervisord</h2>

<ol>
<li><p>install setuptools</p>

<pre><code>wget https://pypi.python.org/packages/2.7/s/setuptools/setuptools-0.6c11-py2.7.egg
...
<li><p>config <code>/etc/supervisord.conf</code></p>

<pre><code>[include]
files = /etc/supervisord.conf.d/*.conf
</code></pre></li>

<li><p>Create new application to be managed</p>

<pre><code>cd /etc/supervisord.conf.d
vim beepkg.conf
</code></pre>

<p>Configurations：</p>

<pre><code>[program:beepkg]
...
<h2>Supervisord Manage</h2>

<p>Supervisord provides two commands, supervisord and supervisorctl:</p>

<ul>
<li>supervisord: Initialize Supervisord, run configed processes<br /></li>
<li>supervisorctl stop programxxx: Stop process programxxx. programxxx is configed name in [program:beepkg]. Here is beepkg.<br /></li>
<li>supervisorctl start programxxx: Run the process.<br /></li>
<li>supervisorctl restart programxxx: Restart the process.<br /></li>
<li>supervisorctl stop groupworker:  Restart all processes in group groupworker<br /></li>
<li>supervisorctl stop all: Stop all processes. Notes: start, restart and stop won&rsquo;t reload the latest configs.<br /></li>
<li>supervisorctl reload: Reload the latest configs.<br /></li>
<li>supervisorctl update: Reload all the processes who&rsquo;s config has changed.<br /></li>
</ul>

<blockquote>
<blockquote>
<blockquote>
<p>Notes: The processes stopped by <code>stop</code> manually won&rsquo;t restart after reload or update.</p>
</blockquote>
</blockquote>
</blockquote>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'deploy\/supervisor.md?lang=en-US';
            </script>
