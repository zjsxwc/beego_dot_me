...
<title>Custom Fields - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/model/custom_fields.md">Custom Fields</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/model/custom_fields.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<pre lang="go"><code>TypeBooleanField = 1 &lt;&lt; iota
...
RelReverseMany
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/model\/custom_fields.md?lang=en-US';
            </script>
