...
<title>Command Line - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/model/cmd.md">Command Line</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/model/cmd.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>You can call <code>orm.RunCommand()</code> after you registered models and database(s) as follows:</p>
...
<pre lang="bash"><code>go build main.go
./main orm
# Get help by just run it.
# If possible, go run main.go orm has the same result.
</code></pre>

<h2>Database Schema Generation</h2>

<pre lang="bash"><code>./main orm syncdb -h
...
<p>Use the <code>-force=1</code> flag to force drop tables and re-create.</p>

<p>Use the <code>-v</code> flag to print SQL statements.</p>

<hr />

<p>Use program to create tables:</p>
...
<p>Even if you do not enable <code>force</code> mode, ORM also will auto-add new fields and indexes, but you have to deal with delete operations yourself.</p>

<h2>Print SQL Statements</h2>

<pre lang="bash"><code>./main orm sqlall -h
Usage of orm command: syncdb:
  -db=&quot;default&quot;: DataBase alias name
</code></pre>

<p>Use database with alias <code>default</code> as default.</p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/model\/cmd.md?lang=en-US';
            </script>
