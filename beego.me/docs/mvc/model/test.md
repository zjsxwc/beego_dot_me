...
<title>Test Cases - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/model/test.md">Test Cases</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/model/test.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<ul>
<li>Model definition <a href="https://github.com/astaxie/beego/blob/master/orm/models_test.go">models_test.go</a><br /></li>
<li>Test cases <a href="https://github.com/astaxie/beego/blob/master/orm/orm_test.go">orm_test.go</a><br /></li>
</ul>

<h4>MySQL</h4>

<pre lang="bash"><code>mysql -u root -e 'create database orm_test;'
...
<pre lang="bash"><code>touch /path/to/orm_test.db
...
<pre lang="bash"><code>psql -c 'create database orm_test;' -U postgres
...
go test -v github.com/astaxie/beego/orm
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/model\/test.md?lang=en-US';
            </script>
