...
<title>FAQ - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/model/faq.md">FAQ</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/model/faq.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>Q: My application need to support multiple database type. How can I check current database type when I am using Raw SQL?</p>

<p>A: You can check it by Ormer&rsquo;s <a href="orm.md#driver">Driver method</a></p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/model\/faq.md?lang=en-US';
            </script>
