...
<title>Template Functions - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/view/template.md">Template Functions</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/view/template.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>Beego supports custom template functions but it must be set as below before <code>beego.Run()</code>:</p>

<pre><code>func hello(in string)(out string){
    out = in + &quot;world&quot;
    return
}
...
<p>Then you can use these functions in template:</p>

<pre><code>{{.Content | hi}}
</code></pre>

<p>Here are Beego&rsquo;s built-in template functions:</p>

<ul>
<li>dateformat<br /></li>
</ul>

<p>Format time, return string. {{dateformat .Time &ldquo;2006-01-02T15:04:05Z07:00&rdquo;}}</p>

<ul>
<li>date<br /></li>
</ul>

<p>This is similar to date function in PHP. It can easily return time by string {{date .T &ldquo;Y-m-d H:i:s&rdquo;}}</p>

<ul>
<li>compare<br /></li>
</ul>

<p>Compare two objects. If they are the same return true otherwise return false. {{compare .A .B}}</p>

<ul>
<li>substr<br /></li>
</ul>

<p>Return sub string. supports UTF-8 string. {{substr .Str 0 30}}</p>

<ul>
<li>html2str<br /></li>
</ul>

<p>Parse html to string by removing tags like script and css and return text. {{html2str .Htmlinfo}}</p>

<ul>
<li><p>str2html<br />
Parse string to HTML, no escaping. {{str2html .Strhtml}}</p></li>

<li><p>htmlquote</p></li>
</ul>

<p>Escaping html. {{htmlquote .quote}}</p>

<ul>
<li>htmlunquote<br /></li>
</ul>

<p>Unescaping to html. {{htmlunquote .unquote}}</p>

<ul>
<li>renderform<br /></li>
</ul>

<p>Generate form from StructTag. {{&amp;struct | renderform}}</p>

<ul>
<li><p>assets_js</p>

<p>Create a <code>&lt;script&gt;</code> tag from js src. {{assets_js src}}</p></li>

<li><p>assets_css</p>

<p>Create a <code>&lt;link&gt;</code> tag from css src. {{assets_css src}}</p></li>

<li><p>config</p>

<p>Get the value of AppConfig. {{config configType configKey defaultValue}}. configType must be String, Bool, Int, Int64, Float, or DIY</p></li>

<li><p>map_get</p>

<p>Get value of <code>map</code> by key</p>
...
<p>Get the URL of a controller method</p>

<pre><code>{{urlfor &quot;TestController.List&quot;}}
</code></pre>

<p><a href="zh-CN/mvc/controller/urlbuilding.md#how-to-use-in-template">详见</a></p></li>
</ul>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/view\/template.md?lang=en-US';
            </script>
