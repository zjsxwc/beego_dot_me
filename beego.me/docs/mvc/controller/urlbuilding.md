...
<title>URL Building - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/controller/urlbuilding.md">URL Building</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/controller/urlbuilding.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>This is how you register the router:</p>
...
<p>This is how you generate the url:</p>
...
<h2>This is how you use it in a template</h2>

<p>beego has already registered the template function <code>urlfor</code>. You can use it like this:</p>
...
<p>Why would you want to build URLs instead of hard-coding them into your templates? There are three good reasons for this:</p>

<ol>
<li>Reversing is often more descriptive than hard-coding the URLs. More importantly, it allows you to change URLs in one go, without having to remember to change URLs all over the place.<br /></li>
<li>URL building will handle escaping of special characters and Unicode data transparently for you, so you don’t have to deal with them.<br /></li>
</ol>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/controller\/urlbuilding.md?lang=en-US';
            </script>
