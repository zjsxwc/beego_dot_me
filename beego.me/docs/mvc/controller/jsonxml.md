...
<title>Response formats - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/mvc/controller/jsonxml.md">Response formats</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/mvc/controller/jsonxml.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<h1>JSON, XML and JSONP</h1>

<p>Beego is also designed for the creation of API applications. When we build an API application, we often need to respond with JSON or XML. Beego provides a simple approach:</p>

<ul>
<li><p>Respond with JSON data:</p>

<pre lang="go"><code>type mystruct struct {
...
<p>ServeJson will set <code>content-type</code> to <code>application/json</code> and JSONify the data.</p></li>

<li><p>Respond with XML data:</p>
...
<p>ServeXml will set <code>content-type</code> to <code>application/xml</code> and convert the data into XML.</p></li>

<li><p>Respond with jsonp</p>
...
<p>ServeJsonp will set <code>content-type</code> to <code>application/javascript</code> , JSONify the data and respond to jsonp based on the request parameter <code>callback</code>.</p></li>
</ul>

<p>In version 1.6 names of methods were changed, it is ServeJSON(), ServeXML(), ServeJSONP() from now on.</p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'mvc\/controller\/jsonxml.md?lang=en-US';
            </script>
