...
<title>URL Shortener - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/examples/shorturl.md">URL Shortener</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/examples/shorturl.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<h1>URL Shortener API service</h1>

<p>This sample is an API application based on Beego. It has two API endpoints:</p>

<p>/v1/shorten<br />
/v1/expand</p>

<p><a href="https://github.com/beego/samples/tree/master/shorturl">Browse the code on GitHub</a></p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'examples\/shorturl.md?lang=en-US';
            </script>
