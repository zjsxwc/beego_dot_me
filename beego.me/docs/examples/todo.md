...
<title>To-do List - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/examples/todo.md">To-do List</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/examples/todo.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>An AngularJS + Beego project</p>

<pre lang="bash"><code> bee new todo
...
<p><a href="https://github.com/beego/samples/tree/master/todo">Browse the code on GitHub</a></p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'examples\/todo.md?lang=en-US';
            </script>
