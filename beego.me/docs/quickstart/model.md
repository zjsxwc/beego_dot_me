...
<title>Models - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/quickstart/model.md">Models</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/quickstart/model.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>Models are normally the best way to handle the numerous databases used in web applications.  The <code>bee new</code> project does not contain an example of models.  Demos on implementing and using models can instead be found in <code>bee api</code> projects.</p>

<p>The Controller can automatically handle models for simple applications.</p>

<p>Larger applications with more reusable code requiring logic separation must use models.  Reusable logic can be factored out into a Model and used to handle database interactions.  The following is an example:</p>
...
<p>Please see <a href="../mvc/model/overview.md">MVC Models</a> for the specific examples of database models and Beego&rsquo;s ORM framework. <a href="view.md">The next section</a> will cover writing views.</p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'quickstart\/model.md?lang=en-US';
            </script>
