...
<title>Create a new project - beego: simple &amp; powerful Go app framework</title>
    ...
    <div class="row">
        <div class="col-md-2 col-sm-3">
            ...
            <ul class="list-unstyled">
                        ...
                        <li><a class="active item" href="/docs/quickstart/new.md">Create a new project</a></li>
        ...
        <div class="col-md-10 col-sm-9">
            <div class="box">
                ...
                <div class="cell slim page-box">
                    <p>
                        <a href="https://github.com/beego/beedoc/blob/master/en-US/quickstart/new.md" class="pull-right btn btn-info" target="_blank">Improve this page on GitHub</a>
...
<p>Before starting any Beego project make sure that you have installed the <code>bee</code> tool and the <code>beego</code> package. If you don&rsquo;t have them yet please read <a href="../install">Installing beego</a> and <a href="../install/bee.md">Installing bee tool</a> before you proceed.</p>

<h1>Creating a new project</h1>

<p>Create a new Beego project with the <a href="../install/bee.md"><code>bee</code> command</a>.</p>

<p>Open a terminal to your <code>$GOPATH</code> directory and enter <code>bee new quickstart</code>:</p>

<pre><code>➜  src  bee new quickstart
...
<p>The bee tool has created a new Beego project with the following structure:</p>
...
<p>This is a typical MVC application and <code>main.go</code> is the project&rsquo;s main file.</p>

<h2>Running project</h2>

<p>Go to the path of the newly created project and enter <code>bee run</code> to compile and run the project.</p>

<pre><code>➜  src  cd quickstart
➜  quickstart  bee run
...
<p>The web application will run on the default Beego port <code>8080</code>. All of this has been accomplished using only Go and Beego, without the need for nginx or apache.  Let&rsquo;s look at our application in the browser now:</p>

<p><img src="../images/beerun.png" alt="" />
</p>

<p>Beego makes it so easy to create a web application! Let&rsquo;s dive into the project now and see how everything works in the <a href="router.md">next section</a>.</p>
            ...
            <script type="text/javascript">
                var disqus_url = 'http://beego.me/docs/' + 'quickstart\/new.md?lang=en-US';
            </script>
